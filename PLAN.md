...
3. **One-pager** — `docs/ONE_PAGER.md` (vấn đề, giải pháp, người dùng mục tiêu, lộ trình triển khai) + kịch bản demo (khung 5 hồi: [docs/WIDGET.md](docs/WIDGET.md) §9); viết sau khi chốt URL public.
