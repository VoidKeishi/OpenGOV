...
> Tài liệu này kể demo theo **trải nghiệm của người dân dùng cổng**, không theo thuật ngữ kỹ thuật — vừa là kịch bản thuyết trình, vừa là checklist test bằng tay (cột "Điều phải thấy" là điều kiện pass/fail). Chi tiết kỹ thuật của từng tính năng: [WIDGET.md](file:///home/lesky/Code/OpenGOV/docs/WIDGET.md), [ARCHITECTURE.md](file:///home/lesky/Code/OpenGOV/docs/ARCHITECTURE.md). Mã lỗi trong ngoặc chỉ dành cho người test đối chiếu — trên màn hình người dùng chỉ thấy lời nhắc dễ hiểu.
...
| 7 | Câu hỏi dạng lựa chọn có **nút bấm sẵn** — chạm một cái là trả lời, không phải gõ. Ngay màn chào, trợ lý hỏi trước: **cá nhân hay doanh nghiệp?** — chọn xong gợi ý thu hẹp đúng nhánh mình cần (chọn tại chỗ, không tốn lượt hỏi); đang đứng sẵn trên trang tờ khai thì trợ lý tự hiểu, khỏi hỏi | A1–A2, B1 |
...
| - | - | - |
| 1 | Mở trợ lý | Màn chào hỏi ngay: làm thủ tục cho **cá nhân hay doanh nghiệp?** — hai nút chọn |
| 2 | Chạm **👤 Cá nhân** | Gợi ý thu hẹp còn các việc cá nhân, kèm nút **↩ Chọn lại**; chưa có tin nhắn nào được gửi — chọn nhánh là thao tác tại chỗ |
| 3 | Bấm nút gợi ý **"Tôi muốn đăng ký thường trú"** | Trợ lý trả lời trôi chảy, rồi hỏi lại **đúng một câu** để hiểu hoàn cảnh, kèm các nút chọn sẵn (nhà của mình / về ở với người thân / thuê, mượn, ở nhờ) |
| 4 | Chạm nút "Có quan hệ nhân thân với chủ hộ" | Câu trả lời được gửi đi như tin nhắn mình gõ; sang lượt mới các nút cũ tự biến mất |
...
| Bước | Làm gì | Điều phải thấy |
| - | - | - |
| 14 | Bấm **✓ Kiểm tra hồ sơ** | Danh sách chỉ đích danh từng ô kèm cách sửa: số định danh phải đủ 12 số (E\_DINH\_DANH\_12); họ tên chủ hộ đang bỏ trống (E\_REQUIRED); **"Hà Giang không còn là tỉnh hiện hành — từ 01/7/2025 đã sáp nhập vào Tuyên Quang, vui lòng ghi Tuyên Quang"** (E\_TINH\_SAP\_NHAP); lưu ý bỏ cấp huyện vì địa chỉ nay chỉ còn 2 cấp (E\_CAP\_HUYEN); và vì mình về **ở nhờ nhà bố** nên phải có ý kiến đồng ý của chủ sở hữu (ERR-TT-06) — đúng hoàn cảnh đã kể ở A5 |
...
| Bước | Làm gì | Điều phải thấy |
| - | - | - |
| 1 | Về trang chủ cổng, bấm **Cuộc mới**, ở màn chào chạm **🏢 Doanh nghiệp** (còn đứng trên tờ khai thường trú thì trợ lý đã tự vào nhánh cá nhân — bấm **↩ Chọn lại** trước) | Gợi ý đổi sang các việc của doanh nghiệp (thành lập DNTN, nội quy lao động) — cùng một trợ lý nhưng mỗi nhóm người dùng thấy đúng việc của mình |
| 2 | Bấm nút gợi ý **"Phí thành lập doanh nghiệp tư nhân?"** | Thẻ lệ phí so sánh rõ: nộp trực tuyến 100.000đ (được miễn khoản lệ phí 50.000đ) — nộp trực tiếp/bưu điện 150.000đ |
...
| Bước | Làm gì | Điều phải thấy |
| - | - | - |
| 4 | Bấm **✓ Kiểm tra hồ sơ** | Bắt được cả những lỗi người thường dễ bỏ qua: mã ngành phải đúng 4 số kèm chỗ tra cứu (ERR-DN-06); **số tiền bằng chữ không khớp bằng số** (E\_SO\_CHU\_LECH); **các khoản vốn góp cộng lại vượt tổng vốn** (E\_GOP\_VON\_VUOT\_TONG); **tên doanh nghiệp không được dùng tên lực lượng vũ trang** (ERR-DN-02); tỉnh cũ đã sáp nhập + thừa cấp huyện; ngày cấp không thể ở tương lai (E\_NGAY\_TUONG\_LAI) |
