...
1. **Nêu nhu cầu bằng lời thường** ("tôi muốn chuyển hộ khẩu về nhà vợ") → hệ thống tìm đúng thủ tục (alias + FTS5 + rerank), hỏi làm rõ tình huống, ghi từng câu trả lời thành **case fact có cấu trúc** → checklist giấy tờ và các bước lọc theo đúng tình huống đó.
...
**Mức 3 — Dẫn thao tác từng bước.** "Đưa tôi đến bước tải giấy tờ" → widget mở đúng section/tab, cuộn tới nơi, đánh số các bước còn lại ngay trên giao diện — người dân được dắt tay qua biểu mẫu nhiều bước thay vì tự mò.
